...
MAXVALX=100.0
MAXVALY=(MAXVALX**3+2*MAXVALX*MAXVALX+MAXVALX+200000) # TODO Plug X into the function to find MAXVALY

totalTrials = 0.0
totalHits = 0.0
currError = 0.0
integralValue=45671667            # TODO plug the integral value here see \/
ideal = integralValue/(MAXVALY) # TODO
